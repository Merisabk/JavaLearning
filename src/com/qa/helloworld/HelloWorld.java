...
public class HelloWorld {  // The naming convention for classes are pascal case. 
	...
	public void helloWorld() {   // this is a method. The naming convention for method and variable is camelcase - the first letter is lower case. 
...
////}
	...
	public String concatText(String x, String y) { // a return method. Its going to take 2 strings and return a string.
		return x + " " + y; 
	}
